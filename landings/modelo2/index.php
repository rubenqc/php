...
<body>
			...
			<div class="col-lg-5 offset-lg-1 itc mt-5">	
				<div class="contenedor">
					<div class="promocion text-center">
						<img src="img/titular1.png" id="img-derecha" class="pt-3 pt-lg-0" style="width:90%">
					</div>
					<br>
					...
					<p class="text-center" style="color:white;font-size:15px;">La devolución se realizará en tu siguiente Estado de Cuenta.</p>
				</div>
				<br>
			</div>
		</div>
	...
	<div class="container-fluid legal" style="padding-bottom: 8px">
		...
		<div class="row no-gutters">
			<div class="col-lg-11 mb-0 text-justify pl-lg-3 mt-1" style="font-size: 13px; color:#333; position: relative;bottom: -5px;color:white;">
